...
* **Масовий імпорт/експорт аудіо**: Додано можливість масово експортувати та імпортувати FSBS аудіо-ресурси у форматі OGG. Включає надійні виправлення роботи з пам'яттю (перевірки меж, фікс витоку та пошкодження пам'яті), щоб редактор не вилітав при зустрічі з пошкодженими файлами гри.
