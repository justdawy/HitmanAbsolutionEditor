...
void CompositionBlueprint::ParseGameCues(void* musicCompositionData)
{
	...
	const unsigned int gameCueCount = ResourceUtility::CalculateArrayElementsCount(gameCuesStartAddress, gameCuesEndAddress, 0x10);
...
void CompositionBlueprint::ParsePlayLists(void* musicCompositionData)
{
	...
	const unsigned int playlistCount = ResourceUtility::CalculateArrayElementsCount(playlistsStartAddress, playlistsEndAddress, 0x2C);
	...
	for (unsigned int i = 0; i < playlistCount; i++)
	{
		...
		const unsigned int nodeCount = ResourceUtility::CalculateArrayElementsCount(nodesStartAddress, nodesEndAddress, 0x38);
		...
		const unsigned int burstCount = ResourceUtility::CalculateArrayElementsCount(burstsStartAddress, burstsEndAddress, 0x18);
...
void CompositionBlueprint::ParseStingers(void* musicCompositionData)
{
	...
	const unsigned int stingerCount = ResourceUtility::CalculateArrayElementsCount(stingersStartAddress, stingersEndAddress, 0x18);
...
void CompositionBlueprint::ParseSegments(void* musicCompositionData)
{
	...
	const unsigned int segmentCount = ResourceUtility::CalculateArrayElementsCount(segmentsStartAddress, segmentsEndAddress, 0x30);
	...
	for (unsigned int i = 0; i < segmentCount; i++)
	{
		...
		const unsigned int trackCount = ResourceUtility::CalculateArrayElementsCount(tracksStartAddress, tracksEndAddress, 0x28);
		...
		for (unsigned int j = 0; j < trackCount; j++)
		{
			...
			const unsigned int entryCount = ResourceUtility::CalculateArrayElementsCount(entriesStartAddress, entriesEndAddress, 0x18);
			...
			for (unsigned int k = 0; k < entryCount; k++)
			{
				...
				const unsigned int variationCount = ResourceUtility::CalculateArrayElementsCount(variationsStartAddress, variationsEndAddress, 0x8);
...
void CompositionBlueprint::ParseTrackExposingGroups(void* musicCompositionData)
{
	...
	const unsigned int trackExposingGroupCount = ResourceUtility::CalculateArrayElementsCount(trackExposingGroupsAddress, trackExposingGroupsEndAddress, 0x20);
	...
	for (unsigned int i = 0; i < trackExposingGroupCount; i++)
	{
		...
		const unsigned int trackNameCount = ResourceUtility::CalculateArrayElementsCount(trackNamesAddress, trackNamesEndAddress, 0x8);
