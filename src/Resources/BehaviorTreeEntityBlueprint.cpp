...
void BehaviorTreeEntityBlueprint::Parse(void* behaviorTreeInfo)
{
	...
	const unsigned int referenceCount = ResourceUtility::CalculateArrayElementsCount(referencesStartAddress, referencesEndAddress, 0xC);
	...
	const unsigned int inputPinConditionCount = ResourceUtility::CalculateArrayElementsCount(inputPinConditionsStartAddress, inputPinConditionsEndAddress, 0x8);
